...
You are given two integer arrays, A and B. B is an anagram of A meaning that B contains all the same elements of A but 
in a different order. Return an array that represents a mapping from every element in A to which index it occurs at in B.
